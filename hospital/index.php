            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="hms/user-login.php">Đặt lịch</a>
                    </div>
                </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Hệ thống đặt lịch khám bệnh trực tuyến</h5>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Đăng nhập với tư cách bênh nhân</h6>
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Ấn vào đây</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Đăng nhập với tư cách bác sĩ</h6>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Đăng nhập với tư cách quản trị viên</h6>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <p>Một số khoa chính của hệ thống</p>
            </div>
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="hdpe">Nha khoa</button>
            <button class="btn btn-default filter-button" data-filter="sprinkle">Tim mạch</button>
            <button class="btn btn-default filter-button" data-filter="spray">Thần kinh học</button>
            <button class="btn btn-default filter-button" data-filter="irrigation">Phòng thí nghiệm</button>
        </div>
        <br/>
            ...
            <div  class="col-sm-12 cop-ck">
                ...
                <h2 >Mẫu liên hệ</h2>
                    ...
                    <div  class="row cf-ro">
                     ...
                     <div  class="row cf-ro">
                        <div  class="col-sm-3"><label>Nhập lời nhắn:</label></div>
                        <div class="col-sm-8">
                     ...
                     <div  class="row cf-ro">
                        ...
                        <div class="col-sm-8">
                         <button class="btn btn-success btn-sm" type="submit" name="submit">Gửi</button>
                        </div>
                </div>
            </form>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        ...
                        <li><a ui-sref="gallery" href="#gallery">Thư viện</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="contact" href="#contact">Liên hệ với chúng tôi</a><i class="fa fa-angle-right"></i></li>
                    </ul>
                </div>
